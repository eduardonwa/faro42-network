...
<div class="flex {{ $loop->last ? '' : 'border-b border-b-gray-400' }} w-full bg-gray-200 rounded-md mb-8">
    <div x-data="{ currentTab: 'first' }">
        ...
        <div class="h-12 w-auto rounded-md bg-blue-100 flex items-center justify-between">
            <button class="rounded-tl-md 2 h-12 w-full hover:bg-gray-900 hover:bg-opacity-5 transition ease-in-out bg-blue-300" x-on:click="currentTab = 'first'" :class="{ 'font-bold bg-opacity-5' : currentTab === 'first' }">I.P.</button>
            ...
            <button class="rounded-tr-md h-12 w-full hover:bg-gray-900 hover:bg-opacity-5 transition ease-in-out bg-blue-300" x-on:click="currentTab = 'sixth'" :class="{ 'font-bold bg-opacity-5' : currentTab === 'sixth' }">Comité</button>    
        </div>
        ...
        <div>
            ...
            <div x-show="currentTab === 'sixth'" class="p-4">
