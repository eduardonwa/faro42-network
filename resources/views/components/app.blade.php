    ...
    <section class="px-8">
        <main class="mx-auto">
            ...
            <div class="lg:flex lg:justify-between">
                ...
                @if ( auth()->check() )
                    <div class="flex items-center justify-between lg:w-32 md:w-32 md:items-start md:relative md:p-0 md:bg-transparent bg-blue-600 w-full p-4 absolute right-0 top-0 z-10">
                        <nav>
