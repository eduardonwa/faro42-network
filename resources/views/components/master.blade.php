...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Faro42') }}</title>
        <!-- Styles -->
        ...
        <div id="app">
            ...
            <section class="px-8 py-3 mb-4 mx-auto">
                <header class="flex flex-col items-center mt-8 md:mt-0 md:flex-row">
                    ...
                    <div class="flex flex-col md:flex-row md:space-y-0 space-y-3 items-center md:justify-end justify-center w-full h-30 space-x-2">
                        @can('create_posts')
